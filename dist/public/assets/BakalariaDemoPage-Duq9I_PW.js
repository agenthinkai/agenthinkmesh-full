import{r as e,j as t}from"./index-CMFS-KMs.js";const a=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
</html>`;function s(){return e.useEffect(()=>(document.title="Bakalaria — Digital Decision Twin · KD 1,000,000 Facility",()=>{document.title="AgenThinkMesh"}),[]),t.jsx("div",{"data-loc":"client/src/pages/BakalariaDemoPage.tsx:362",style:{width:"100vw",height:"100vh",overflow:"hidden"},children:t.jsx("iframe",{"data-loc":"client/src/pages/BakalariaDemoPage.tsx:363",srcDoc:a,style:{width:"100%",height:"100%",border:"none",display:"block"},title:"Bakalaria Digital Decision Twin",sandbox:"allow-scripts"})})}export{s as default};
