...
const ArosProof = lazy(() => import("./pages/aros/ArosProof"));
const ArosBoardPack = lazy(() => import("./pages/aros/ArosBoardPack"));
...
const LPTwinLaboratory = lazy(() => import("./pages/LPTwinLaboratory"));
const LPTwinMeetingRoom = lazy(() => import('./pages/LPTwinMeetingRoom'));
...
const Core42CommandCenter = lazy(() => import("./pages/Core42CommandCenter"));
...
function Router() {
  ...
  return (
    ...
    <Switch>
      ...
      <Route path="/aros/proof" component={ArosProof} />
      ...
      <Route path="/core42-demo" component={Core42CommandCenter} />
      ...
      <Route path="/captwin/lp-twin/fund/:fundId/laboratory" component={LPTwinLaboratory} />
