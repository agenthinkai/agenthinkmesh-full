...
export default function IndonesiaLogisticsDemo() {
  useEffect(() => {
    document.title = "Indonesia Logistics — Sovereign AI Command Center";
  ...
  return (
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden" }}>
      <iframe
        ...
        title="Indonesia Logistics Sovereign AI Command Center"
