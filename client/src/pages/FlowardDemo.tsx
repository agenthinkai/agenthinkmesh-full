...
export default function FlowardDemo() {
  useEffect(() => {
    document.title = "Floward — Sovereign E-Commerce & Perishable Logistics AI";
  ...
  return (
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden" }}>
      <iframe
        ...
        title="Floward Sovereign E-Commerce & Perishable Logistics AI Command Center"
