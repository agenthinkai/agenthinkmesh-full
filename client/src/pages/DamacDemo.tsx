...
// Inline the full static HTML so it works without any backend
const DAMAC_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
export default function DamacDemo() {
  useEffect(() => {
    document.title = "DAMAC Sovereign AI Command Center";
  ...
  return (
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden" }}>
      <iframe
        ...
        title="DAMAC Sovereign AI Command Center"
