...
export default function Core42CommandCenter() {
  useEffect(() => {
    document.title = "Core42 × MeshPilot — Sovereign AI Command Center";
  ...
  return (
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden" }}>
      <iframe
        ...
        title="Core42 × MeshPilot Sovereign AI Command Center"
