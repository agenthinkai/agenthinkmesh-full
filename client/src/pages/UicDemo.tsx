...
export default function UicDemo() {
  useEffect(() => {
    document.title = "UIC — Sovereign Financial Intelligence Command Center";
  ...
  return (
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden" }}>
      <iframe
        ...
        title="UIC Sovereign Financial Intelligence Command Center"
