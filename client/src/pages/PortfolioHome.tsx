...
const WORKFLOWS = [
  ...
  },
  {
    ...
    subtitle: "Investment Thesis Validation",
    description:
      "Screen inbound opportunities against your investment thesis. Analyse financials, market position, and risk factors in seconds.",
    badge: "Coming Soon",
